...
public class Terrain {
    int res = 1;
    int smoothness = 4;
    double[] heights = new double[20 / smoothness / res + 1];
    double[] uheights = new double[20 / res + 1];
    String[][] ores = new String[20 / res][20/ res];
    int sx = 0;
    int sy = 0;
    int sxp = 0;
    int syp = 0;
    ...
    public void init() {
        ...
        for (int i = 0; i < heights.length - 1; i++) {
            ...
            for (int j = (20 / res) - 1; j > ((int) (heights[i] * v) / res) + o / res; j--) {
            ...
            for (int j = 1; j < smoothness; j++) {
                ...
                for (int jj = (20 / res) - 1; jj > ((int) (interpolate(heights[i], heights[i + 1], (1.0 / smoothness) * j) * v) / res) + o / res; jj--) {
